...
public class FluentUiDemoDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public FluentUiDemoDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
