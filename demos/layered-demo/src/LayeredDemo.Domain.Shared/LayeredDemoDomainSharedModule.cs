...
public class LayeredDemoDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        LayeredDemoGlobalFeatureConfigurator.Configure();
        LayeredDemoModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<LayeredDemoDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<LayeredDemoResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/LayeredDemo");

            options.DefaultResourceType = typeof(LayeredDemoResource);
        ...
        {
            options.MapCodeNamespace("LayeredDemo", typeof(LayeredDemoResource));
        });
    }
}
