      ...
      ITodoAppService
{
        ...
        : base(repository)
    {
        ...
        GetPolicyName = LayeredDemoPermissions.Todos.Default;
        GetListPolicyName = LayeredDemoPermissions.Todos.Default;
        CreatePolicyName = LayeredDemoPermissions.Todos.Create;
        UpdatePolicyName = LayeredDemoPermissions.Todos.Edit;
        DeletePolicyName = LayeredDemoPermissions.Todos.Delete;
    }
