...
public class AngularDemoDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AngularDemoGlobalFeatureConfigurator.Configure();
        AngularDemoModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AngularDemoDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AngularDemoResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AngularDemo");

            options.DefaultResourceType = typeof(AngularDemoResource);
        ...
        {
            options.MapCodeNamespace("AngularDemo", typeof(AngularDemoResource));
        });
    }
}
