...
public class MudBlazorDemoDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MudBlazorDemoGlobalFeatureConfigurator.Configure();
        MudBlazorDemoModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MudBlazorDemoDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MudBlazorDemoResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MudBlazorDemo");

            options.DefaultResourceType = typeof(MudBlazorDemoResource);
        ...
        {
            options.MapCodeNamespace("MudBlazorDemo", typeof(MudBlazorDemoResource));
        });
    }
}
